...
class CommandRouter:
    COMMAND_SPECS = {
        ...
        "sim":         {"method": "semantic.search", "args": ["id", "limit", "meta"], "desc": "Atoms semantically like THIS atom (anchored on its own meaning; meta=1 to include lexicon defs)"},
        "similar":     {"method": "semantic.search", "args": ["id", "limit", "meta"], "desc": "Semantic neighbours (alias of sim)"},
        "search":      {"method": "semantic.search", "args": ["query", "limit", "meta"], "desc": "Semantic text search: search query=<text> (meta=1 to include lexicon defs)"},
        "node.sim":    {"method": "node.sim",        "args": ["id", "limit", "meta"], "desc": "Atoms structurally similar to THIS atom (connected the same way; meta=1 for lexicon defs)"},
        "node.similar":{"method": "node.sim",        "args": ["id", "limit", "meta"], "desc": "Structural neighbours (alias of node.sim)"},
